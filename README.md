...
(depending on selection made in the code) applies the effects to the audio file and saves them to a new file. Input and output file paths must be specified.
